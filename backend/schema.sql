...
CREATE TABLE treatments (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    treatment_number VARCHAR(30) UNIQUE NOT NULL DEFAULT ('TRT-' || TO_CHAR(CURRENT_DATE, 'YYYYMMDD') || '-' || LPAD(NEXTVAL('invoice_number_seq')::TEXT, 5, '0')),
    patient_id BIGINT NOT NULL REFERENCES patients(id) ON DELETE CASCADE,
    diagnosis_name VARCHAR(255) NOT NULL,
    diagnosis_type VARCHAR(50) NOT NULL CHECK (diagnosis_type IN ('Hair Diagnosis', 'Skin Diagnosis', 'Both Hair & Skin')),
    treatment_amount DECIMAL(10,2) NOT NULL CHECK (treatment_amount > 0),
    payment_mode VARCHAR(50) NOT NULL CHECK (payment_mode IN ('Cash', 'UPI', 'Debit/Credit Card', 'Card')),
